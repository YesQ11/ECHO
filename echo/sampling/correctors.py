...
class Corrector(abc.ABC):
    ...
    def __init__(self, sde, score_fn, snr, n_steps, **kwargs):
        super().__init__()
...
class AnnealedLangevinDynamics(Corrector):
    ...
    def __init__(self, sde, score_fn, snr, n_steps,**kwargs):
        super().__init__(sde, score_fn, snr, n_steps,**kwargs)
        self.sde = sde
        self.score_fn = score_fn
        self.snr = snr
        self.n_steps = n_steps
        self.pred_obj = kwargs.get("pred_obj","score")
