...
deform_conv2d = layerspp.DeformConv2DLayer
deform_combine = layerspp.Combine_deform

@BackboneRegistry.register("ncsnpp_deform")
class NCSNpp_deform(nn.Module):
    ...
    def add_argparse_args(parser,config):
        ...
        parser.add_argument("--dose_dropout_nn", default=config.get('dose_dropout'), help="Dropout rate for the backbone.")
    ...
    def __init__(self,
        ...
        **kwargs
        ...
        combiner = functools.partial(deform_combine, method=combine_method)
        self.output_layer = deform_conv2d(num_channels, 2, kernel_size=1, padding=0, init_scale=init_scale)

        dose_dropout=kwargs.get('dose_dropout_nn', 0.0)
        ...
        modules.append(deform_conv2d(channels, nf))
