...
from echo.util.other import set_torch_cuda_arch_list
import torch
set_torch_cuda_arch_list()
torch.set_float32_matmul_precision('high')


from echo.backbones.shared import BackboneRegistry
from echo.data_module import SpecsDataModule
from echo.sdes import SDERegistry
from echo.model import ScoreModel
...
if __name__ == '__main__':
     ...
     for parser_ in (base_parser, parser):
          ...
          parser_.add_argument("--sde", type=str, choices=SDERegistry.get_all_names(), default='echo_sde')
